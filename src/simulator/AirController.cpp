...
AirController::doWork()
{
			...
			Position pos_circuito_0(20000.0, -6000.0, 500.0);
			Position pos_circuito_1(10000.0, 6000.0, 500.0);
			Position pos_circuito_2(10000.0, 6000.0, 500.0);
			Position pos_circuito_3(-10000.0, -6000.0, 500.0);
			...
			/*if(!Airport::getInstance()->is_booked_landing()) //crear is_booked_landing en la clase
			{
